...
\newcommand{\projectTitle}{Recipe Recommendation, Visualisation and Collation Web Application}
\newcommand{\fullname}{Jake Callum Richard Kadir}
\newcommand{\degreeTitle}{BSc Computer Science (Digital \& Technology Solutions)}
	% e.g. BSc Computer Science
\newcommand{\session}{2022/2023}
	% e.g. 2021/22
\newcommand{\module}{COMP3932}
